...
import { cryptoGiveawaysItems } from '@/data/competitions'  // Import from wherever you're storing this array
      ...
      <main className="app-background min-h-screen px-4 py-8 text-white">
        <div className="max-w-screen-lg mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {cryptoGiveawaysItems.map((item, idx) => (
              <CryptoGiveawayCard key={idx} {...item} />
            ))}
          </div>
        </div>
      </main>
