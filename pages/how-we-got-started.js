      ...
      >
        <div className="competition-card max-w-3xl w-full bg-white">
          ...
          <div className="p-6 space-y-6 text-black">
            ...
            <h2 className="font-bold mt-6">Finding Pi — And Believing in It Early</h2>
            <p>
            ...
            <h2 className="font-bold mt-6">The Great KYC Race</h2>
            <p>
            ...
            <h2 className="font-bold mt-6">Learning From Scratch</h2>
            <p>
            ...
            <h2 className="font-bold mt-6">The Birth of OhMyCompetitions</h2>
            <p>
            ...
            <h2 className="font-bold mt-6">The First Wins</h2>
            <p>
            ...
            <h2 className="font-bold mt-6">Where We’re Headed</h2>
            <p>
            ...
            <h2 className="font-bold mt-6">A Final Thank You</h2>
            <p>
