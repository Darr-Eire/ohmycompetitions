...
export default function HomePage() {
  ...
  // Trigger Pi login (SDK init in _document.js)
  ...
  // Reset carousel scroll when out of view
  useEffect(() => {
    function onScroll() {
  ...
  const techItems = [
    ...
    { comp: { slug: '55-inch-tv-giveaways', entryFee: 0.25, totalTickets: 1400, ticketsSold: 0, endsAt: '2025-05-08T11:30:00Z' }, title: '55″ TV Giveaway', prize: '55″ Smart TV', fee: '0.25 π', href: '/competitions/55-inch-tv-giveaway', imageUrl: '/images/tv.jpg', theme: 'tech' },
