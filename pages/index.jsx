...
export default function HomePage() {
  ...
  const techItems = [
    { comp: { slug: 'ps5-bundle-giveaway' }, title: 'PS5 Bundle Giveaway', prize: 'PlayStation 5', fee: '0.8 π', href: '/competitions/ps5-bundle-giveaway', imageUrl: '/images/playstation.jpeg', theme: 'tech' }
  ]
