...
{ id: 'pi-coin-name',
  question: 'What is Pi Network’s native coin called?',
  answers: ['pi', 'π'],
  tags: ['pi'],
  difficulty: 'easy' },

{ id: 'pi-symbol',
  question: 'What symbol represents Pi Network’s coin?',
  answers: ['π', 'pi'],
  tags: ['pi'],
  difficulty: 'easy' },

{ id: 'pi-users-name',
  question: 'What is the community nickname for Pi Network users?',
  answers: ['pioneer', 'pioneers'],
  tags: ['pi'],
  difficulty: 'easy' },

{ id: 'pi-kyc',
  question: 'In Pi Network, what does KYC stand for?',
  answers: ['know your customer'],
  tags: ['pi'],
  difficulty: 'easy' },

{ id: 'pi-mining-button',
  question: 'Which button do you press to start a new Pi mining session?',
  answers: ['lightning', '⚡', 'bolt', 'thunder', 'flash', 'lightning button'],
  tags: ['pi'],
  difficulty: 'easy' },
...
{ id: 'brazil-language',
  ...
  answers: ['portuguese'],
  tags: ['general', 'language', 'geography'],
  difficulty: 'easy' },

{ id: 'mix-red-blue',
  question: 'What color do you get when you mix red and blue?',
  answers: ['purple', 'violet'],
  tags: ['general', 'colors'],
  difficulty: 'easy' },
