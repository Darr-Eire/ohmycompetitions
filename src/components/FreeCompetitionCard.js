...
export default function FreeCompetitionCard({ comp = {}, title, prize }) {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (diff <= 0) setTimeLeft(t('ended', 'Ended'));
      else {
          ...
          `}>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 text-xs">
                ...
                <span
                  className={`rounded-full px-3 py-1 font-bold ${statusLabel === t('open', 'Open')
            ...
            <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 gap-2">
              ...
              <StatChip label={t('location', 'Location')} value={comp.location || t('global_online', 'Global • Online')} />
            </div>
