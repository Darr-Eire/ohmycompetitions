// ============================================================================
// PATH: src/pages/api/pi/incomplete.js  (SERVER)
// Lists server-side incomplete payments for auto-clear UI.
// ============================================================================
...
export default async function handler(req, res) {
  ...
  const apiKey = process.env.PI_API_KEY_TESTNET; // <-- set in Vercel for testnet
  ...
  try {
    ...
    return res.status(status).json({ ok: false, error: 'Fetch incomplete failed', details: e?.response?.data || e?.message });
  }
}
