        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#0f172a] p-4 rounded-lg border border-green-500/30">
            ...
            <ul className="text-sm text-gray-300 space-y-1">
              <li>• Refer friends and get an entry into our monthly draw for <span className="text-white font-semibold">100 π</span>.</li>
              <li>• Every successful referral = <span className="text-white font-semibold">one extra entry</span>.</li>
              <li>• Your friend also starts with <span className="text-white font-semibold">bonus tickets</span> to boost their odds.</li>
              <li className="text-xs text-gray-400 mt-1">* Winners announced monthly. Terms apply.</li>
            </ul>
          </div>
        </div>
