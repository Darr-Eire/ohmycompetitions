  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Oh My Competitions is built for Pioneers, powered by Pi. Fair, transparent and fun Pi-powered competitions and mini-games." />
      ...
      <main className="app-background min-h-screen text-white">
        ...
        <div className="mx-auto w-full max-w-5xl px-3 sm:px-4">
          {/* card shell */}
          <div className="competition-card mx-auto mt-8 sm:mt-14 w-full max-w-3xl rounded-2xl bg-white/10 shadow-lg backdrop-blur-md border border-cyan-500/30">

            {/* banner */}
            <div className="competition-top-banner title-gradient text-center rounded-t-2xl px-3 py-7 sm:py-9">
              ...
              <p className="mt-2 text-white text-[13px] sm:text-lg leading-relaxed">
            ...
            <div className="p-5 sm:p-8 space-y-8 sm:space-y-10">
              ...
              <section className="relative">
                <h2 className="gradient-text text-center text-2xl sm:text-2xl font-bold mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto">
                  {/* community */}
                  <div className="glass-card group border border-cyan-400/40 rounded-2xl p-4 sm:p-6 shadow-neon hover:shadow-cyan-500/40 transition">
                  ...
                  {/* utility */}
                  <div className="glass-card group border border-green-400/40 rounded-2xl p-4 sm:p-6 shadow-neon hover:shadow-green-500/40 transition">
                    <div className="flex items-center gap-2.5 mb-2">
                      <span className="text-xl sm:text-2xl">🔗</span>
                  ...
                  {/* fairness */}
                  <div className="glass-card group border border-purple-400/40 rounded-2xl p-4 sm:p-6 shadow-neon hover:shadow-purple-500/40 transition">
                    <div className="flex items-center gap-2.5 mb-2">
                      <span className="text-xl sm:text-2xl">🔐</span>
                  ...
                  {/* connecting dapps */}
                  <div className="glass-card group border border-pink-400/40 rounded-2xl p-4 sm:p-6 shadow-neon hover:shadow-pink-500/40 transition">
                    <div className="flex items-center gap-2.5 mb-2">
                      <span className="text-xl sm:text-2xl">🤝</span>
              ...
              <section className="space-y-3 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold gradient-text">Discovering Pi Network</h2>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
                ...
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
                  My friend joked, <em>“If it ever hits 5¢, that’s still good for free mining.”</em> But I looked past price it was about the vision and the ecosystem it could build.
                </p>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
              ...
              <section className="space-y-3 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold gradient-text">Built by Beginners. Fueled by Belief.</h2>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
              ...
              <section className="space-y-3 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold gradient-text">When the Magic Clicked</h2>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
                  The first time Pi Login worked end-to-end frontend, backend, wallet it felt like magic. I nearly Pi-danced in the living room.
                </p>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
              ...
              {/* current status */}
              <section className="space-y-3 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold gradient-text">Where We Are Now</h2>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
                  🎮 Real games<br />
                  🎁 Real prizes<br />
                ...
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
                  OMC isn’t just an idea anymore. It’s a and a promise to reward the Pi community for being early, curious and relentless.
                </p>
              </section>

              {/* future */}
              <section className="space-y-3 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold gradient-text">Where We’re Going</h2>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
              ...
              {/* thank you */}
              <section className="space-y-3 sm:space-y-4">
                <h2 className="text-xl sm:text-2xl font-bold gradient-text">Thank You, Pioneers</h2>
                <p className="text-[13px] sm:text-lg leading-relaxed text-white/90">
              ...
              <div className="text-center pt-2 sm:pt-4">
               ...
               <button className="px-5 py-2.5 sm:px-6 sm:py-3 text-sm sm:text-lg rounded-full border border-cyan-400/60 bg-white/5 backdrop-blur hover:bg-white/10 shadow-[0_0_20px_#22d3ee33] transition focus:outline-none focus:ring-2 focus:ring-cyan-400/70">
